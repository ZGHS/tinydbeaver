...
var require_helper = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var path$4 = __require("path"), Stream = __require("stream").Stream, split = require_split2(), util$2 = __require("util"), defaultPort = 5432, isWin = process.platform === "win32", warnStream = process.stderr;
...
var require_lib$2 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	__require("path");
	var fs$4 = __require("fs"), helper = require_helper();
...
var init_esm = __esmMin((() => {
	import_lib$1 = /* @__PURE__ */ __toESM(require_lib$1(), 1);
	import_lib$1.default.Client;
	Pool = import_lib$1.default.Pool;
...
var require_bindings = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	* Module dependencies.
	*/
	var fs$3 = __require("fs"), path$3 = __require("path"), fileURLToPath = require_file_uri_to_path(), join = path$3.join, dirname = path$3.dirname, exists = fs$3.accessSync && function(path) {
		try {
...
//#endregion
//#region node_modules/better-sqlite3/lib/index.js
...
var import_lib, postgresPool, sqliteDb, currentConnection;
...
var SERVICE_NAME, PASSWORD_PATH;
var init_password = __esmMin((() => {
	SERVICE_NAME = "TinyDB Studio";
	PASSWORD_PATH = path.join(process.env.APPDATA || process.env.HOME || "/tmp", ".tinydb-studio-passwords.json");
}));
//#endregion
...
__esmMin((() => {
	init_database();
	init_password();
	CONFIG_PATH = path.join(app.getPath("userData"), "connections.json");
